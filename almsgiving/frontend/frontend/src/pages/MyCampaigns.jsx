...
export default function MyCampaigns() {
  ...
  if (loading) return <p className="p" style={{ padding: 16 }}>Loading your campaigns…</p>;
      ...
      <div className="container">
        <div className="card card-pad">
          <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
            <div>
              <h1 className="h1" style={{ marginBottom: 6 }}>My Campaigns</h1>
        ...
        {campaigns.length === 0 ? (
          <p className="p" style={{ padding: 16 }}>No campaigns yet.</p>
        ) : (
